# PROGRESS.md — AI_Engineer-DL
# Update after every session. One line per completed artifact.
...
| 05 — Sequence Models | ⏳ Not started |
...
| Notebook | `03_backprop_shallow_nn.ipynb` | ⬜ |
| Notes | (per notebook) | ⬜ |
| Exercises | (per notebook) | ⬜ |
...
| Notebook | `02_deep_nn_backpropagation.ipynb` | ⬜ |
| Notebook | `03_parameters_vs_hyperparameters.ipynb` | ⬜ |
| Notes | (per notebook) | ⬜ |
| Exercises | (per notebook) | ⬜ |

---

## Course 02 — Improving Deep Neural Networks
*(fill in when Course 01 is complete)*

## Course 03 — Structuring ML Projects
*(fill in when Course 02 is complete)*

## Course 04 — Convolutional Neural Networks
*(fill in when Course 03 is complete)*

## Course 05 — Sequence Models
*(fill in when Course 04 is complete)*

---

## Projects
| Project | After | Status |
|---------|-------|--------|
| `cat_classifier` | Course 01 | ⬜ |
| `digit_recognizer` | Course 02 | ⬜ |
| `object_detector_lite` | Course 04 | ⬜ |
| `sentiment_analyzer` | Course 05 | ⬜ |
| `mini_transformer` | Course 05 | ⬜ |